...
export function InvoicePaymentPage({
  ...
  // # Buy note
  buyNote = 'By confirming your payment, you allow Bookeepz Technology, Inc. to charge you for this payment and save your payment information in accordance with their terms.',

  // # Copyright
  copyrightText = `© 2024 Bookeepz Technology, Inc. <br /> All rights reserved.`,
  classNames,
}: PaymentPageProps) {
  return (
