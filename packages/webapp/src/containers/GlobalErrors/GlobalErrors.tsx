...
function GlobalErrorsInner({
  ...
  if (globalErrors.subscriptionInactive) {
    AppToaster.show({
      message: `You can't add new data to Bookeepz because your subscription is inactive. Make sure your billing information is up-to-date from Preferences > Billing page.`,
      intent: Intent.DANGER,
      onDismiss: () => {
